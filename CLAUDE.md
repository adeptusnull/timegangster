...
@![NPM Version](https://www.npmjs.com/package/@modelcontextprotocol/sdk)
@![MIT License](LICENSE)
...
- Handle timezone operations using Luxon, default being eastern standard time
- Support ISO 8601 compliant date/time formats

## Architecture Guidelines
- No web frameworks (Express, Koa, Next.js, etc.) required for basic usage
- Pure MCP server implementation using `@modelcontextprotocol/sdk`
- Focus on tool-based architecture for operations
- Implement proper error handling and validation
- Support timezone-aware operations where needed, default timezone being eastern standard time, unless specified by user. 
